...
const projects: Project[] = [
  {
    ...
    demo: "https://asainikhil99.github.io/portfolioReact/",
    category: "frontend",
  },
  {
    id: 2,
    ...
    image: "/portfolioReact/images/placeholder.png",
...
export default function ProjectsSection() {
  ...
  return (
    <section
      ...
      id="projects"
    >
      <div className="absolute inset-0 bg-[url('/portfolioReact/grid.svg')] opacity-5" />
